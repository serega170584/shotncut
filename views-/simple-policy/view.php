...
$policy_content = $model->renderArticle($this);
            ...
            <div class="si-good-section-hero__content">
                ...
                <div class="si-good-section-hero__text"><?php echo Html::encode(strip_tags($model->preview_text)); ?></div>
                    ...
                    <div class="si-good-section-hero__action">
                        ...
                        <?php if (trim(@$model->link)) { ?>
                            <a href="<?=@$model->link?>" class="sb-button sb-button_s_m sb-button_theme_white"><span class="sb-button__text">Оформить полис</span></a>
                            <?php
                        } ?>

                        <?php if (trim(@$model->link2)) { ?>
                            <a href="<?=@$model->link2?>" class="sb-button sb-button_s_m sb-button_theme_white policy__sb-button_prod"><span
                                    class="sb-button__text">Продлить
                                полис</span></a>
                            <?php
                        } ?>
