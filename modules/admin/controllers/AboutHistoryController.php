 ...
 */
class AboutHistoryController extends CrudController
{
    /**
    ...
    protected function getActiveQuery()
    {
        ...
        return AboutHistory::find()->byCompany($comp_cr)->orderBy(['rating' => SORT_ASC, 'sort' => SORT_ASC]);
    }
