(function ($, $document, $window) {
  ...
  $.fn.content_constructor('register_type', 'policyHowToMake', {
    title: 'Как оформить',
      ...
      self.render = function () {
        ...
        self._createGroups = function(data){
            ...
            for(var i=0; i < limit; i++){
                ...
                item += '<div class="form-group"><label>Изображение</label><input type="file" name="file"/><div class="image-info"></div><input type="hidden" name="'+n+'['+i+'][image]"/></div>';
                ...
                window.CcPolicyHowToMakeTinyMce('#' + mce_text_id);
                window.CcPolicyHowToMakeTinyMce('#' + mce_add_id);
            }
        };
