(function ($, $document, $window) {
  ...
  $.fn.content_constructor('register_type', 'policyQuestions', {
    ...
    creator: function (name, count, $decorator, options) {
      ...
      self.render = function () {
        ...
        html += '<button class="cc_questions_use_add_line btn btn-primary">Добавить строку</button>';
        html += '</div>';
      ...
      self._addLine = function (name, value) {
        ...
        //подключаем tiny mce
        window.CcPolicyQuestionsTinyMce('#cc_' + count + '_questions');
      };
