...
<div id="anchor-info" class="si-good-section si-good-section_background_grey">
    <div class="container container_s_m">
        <div class="si-layout-section si-layout-section_s_m">
            <div class="si-good-caption si-good-caption_accentuated">
                <div class="si-good-caption__text">Подробнее о полисе</div>
            </div>
        </div>
        <div class="si-layout-section si-layout-section_s_m">
            <si-good-tabs>
...
//                                            echo sprintf('%02d', $index);
    ...
    <?php $this->params['leftMenuItems'][] =
        '<a href="#anchor-info" class="si-link"><span class="sb-good-anchor__icon sb-good-anchor__icon_info sb-icon"></span><span class="si-link__text">Подробности</span></a>'; ?>
<?php endif; ?>