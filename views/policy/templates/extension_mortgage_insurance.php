...
<script src="js/pages/mortgage-insurance.js"></script>
    ...
    <section class="js-section-calc b-first-section b-first-section__family-protection">
        <div class="b-wrapper">
            <div class="b-product__wrapper">
                ...
                <form action="" class="js-calc b-calc b-calc__mortgage">
                    ...
                    <div class="js-calc-section u-clear-fix b-calc__section">
                        <div class="u-clear-fix b-calc__section_column">
                            ...
                            <div class="js-who-dropdown b-dropdown__box b-dropdown__box_who">
                                ...
                                <input class="hidden js-input-for-select b-input" id="mortgageForm_who" name="mortgageForm[who]" type="text">
                            </div>
                        </div>
                        <div class="u-clear-fix b-calc__section_column">
                            <label for="mortgageForm_price" class="b-calc__label">со страховой защитой</label>
                            <div class="b-calc__section_column">
                                <input type="text" class="js-max-price b-input" id="mortgageForm_price" name="mortgageForm[price]">
                                <span class="b-input_faq">не менее 40 000 <span class="b-rub">a</span></span>
                            </div>
                            <label for="mortgageForm_price" class="b-calc__label"><span class="b-rub">a</span></label>
                        </div>
                    </div>
