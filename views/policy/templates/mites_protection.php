...
<script src="js/pages/mites-protection.js"></script>
...
<div class="js-top-result-fix b-bg b-bg__top">
    ...
    <section class="js-section-calc b-first-section b-first-section__mites-protection">
        <div class="b-wrapper">
            ...
            <div class="js-calc-result-blocks js-calc-top-result b-calc__result b-calc__result_alone calculated">
                ...
                <div class="u-clear-fix b-calc__result_wrapper">
                            <span class="js-calc-result-top-text b-text__bigger">
                                Полис на<br><span>год с защитой </span>100 000 <span class="b-rub">a</span>
                            </span>
                    <div class=" b-calc__result_sum">
                        <span class="b-calc__result_sum-small">от </span><span class="js-calc-result-sum">470</span><span class="b-rub">c</span>
                    </div>
