 ...
 */
?>
<script src="js/pages/panaceya.js"></script>
...
<div class="js-top-result-fix b-bg b-bg__top">
    ...
    <section class="js-section-calc b-first-section b-first-section__panaceya">
        <div class="b-wrapper">
            <div class="b-product__wrapper">
                ...
                <form action="" class="js-calc b-calc b-calc__panaceya">

                    <div class="js-calc-section u-clear-fix b-calc__section">
                        <div class="u-clear-fix b-calc__section_column">
                            <label class="b-calc__label">Сумма страхового покрытия –</label>
                            <div class="js-price-dropdown b-dropdown__box b-dropdown__box_price">
                                <div class="b-dropdown b-dropdown_open first-open">
                                    ...
                                    <ul class="b-dropdown__sub">
                                        <li data-email="" class="b-dropdown__item">1 500 000 <span class="b-rub">a</span></li>
                                        <li data-email="" class="b-dropdown__item">2 500 000 <span class="b-rub">a</span></li>
                                    </ul>
                                </div>
                                <input class="hidden js-price-input js-input-for-select b-input" id="panaceyaForm_price" name="panaceyaForm[price]" type="text">
                            </div>
                        </div>
                        <div class="u-clear-fix b-calc__section_column">
                            <label class="b-calc__label">Возраст –</label>
                            <div class="js-age-dropdown b-dropdown__box b-dropdown__box_age">
                                <div class="b-dropdown b-dropdown_open first-open">
                                    <div class="b-dropdown__arrow"></div>
                                    <span class="b-dropdown__text js-link-stop"></span>
                                    <ul class="b-dropdown__sub">
                                        <li data-email="" class="b-dropdown__item">18-30</li>
                                        <li data-email="" class="b-dropdown__item">31-40</li>
                                        <li data-email="" class="b-dropdown__item">41-50</li>
                                    </ul>
                                </div>
                                <input class="hidden js-input-for-select b-input" id="panaceyaForm_age" name="panaceyaForm[age]" type="text">
                            </div>
                            <label class="b-calc__label">лет</label>
                        </div>
                    </div>
