 ...
 */
?>
<script src="js/pages/family-protection.js"></script>
                ...
                <form action="" class="js-calc b-calc b-calc__family-protection">
                    ...
                    <div class="js-calc-section u-clear-fix b-calc__section">
                        <div class="u-clear-fix b-calc__section_column">
                            <label class="b-calc__label">Кто будет застрахован</label>
                            <div class="js-who-dropdown b-dropdown__box b-dropdown__box_who">
                                <div class="b-dropdown b-dropdown_open first-open">
                                    ...
                                    <ul class="b-dropdown__sub">
                                        <li data-email="" class="b-dropdown__item">Дети</li>
                                        <li data-email="" class="b-dropdown__item">Супруги</li>
                                        <li data-email="" class="b-dropdown__item">Родители</li>
                                    </ul>
                                </div>
                                <input class="hidden js-input-for-select b-input" id="familyprotectionForm_who" name="familyprotectionForm[who]" type="text">
                            </div>
                        </div>
                        <div class="u-clear-fix b-calc__section_column">
                            ...
                            <div class="js-price-dropdown b-dropdown__box b-dropdown__box_price">
                                <div class="b-dropdown b-dropdown_open first-open">
                                    ...
                                    <span class="b-dropdown__text js-link-stop"></span>
                                    <ul class="b-dropdown__sub">
                                        <li data-email="" class="b-dropdown__item">100 000 <span class="b-rub">a</span></li>
                                        <li data-email="" class="b-dropdown__item">200 000 <span class="b-rub">a</span></li>
                                        <li data-email="" class="b-dropdown__item">500 000 <span class="b-rub">a</span></li>
                                    </ul>
                                </div>
                                <input class="hidden js-price-input js-input-for-select b-input" id="familyprotectionForm_price" name="familyprotectionForm[price]" type="text">
                            </div>
                        </div>
                    </div>
