...
<script src="js/pages/card-protection.js"></script>
...
<div class="js-top-result-fix b-bg b-bg__top">
    ...
    <section class="js-section-calc b-first-section b-first-section__family-head">
        <div class="b-wrapper">
            <div class="b-product__wrapper">
                ...
                <form action="" class="js-calc b-calc b-calc__family-head">

                    <div class="js-calc-section u-clear-fix b-calc__section">
                        <div class="u-clear-fix b-calc__section_column">
                            <label class="b-calc__label">Сумма страховой защиты – </label>
                            <div class="js-price-dropdown b-dropdown__box b-dropdown__box_price">
                                <div class="b-dropdown b-dropdown_open first-open">
                                    ...
                                    <ul class="b-dropdown__sub">
                                        <li data-email="" class="b-dropdown__item">30 000 <span class="b-rub">a</span></li>
                                        <li data-email="" class="b-dropdown__item">120 000 <span class="b-rub">a</span></li>
                                        <li data-email="" class="b-dropdown__item">250 000 <span class="b-rub">a</span></li>
                                    </ul>
                                </div>
                                <input class="hidden js-price-input js-input-for-select b-input" id="familyheadForm_price" name="familyheadForm[price]" type="text">
                            </div>
                        </div>
                    </div>
